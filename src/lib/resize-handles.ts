...
export const RESIZE_HANDLES = [
  { id: 'nw', x: 0, y: 0, offsetX: -RESIZE_HANDLE_CORNER_OFFSET, offsetY: -RESIZE_HANDLE_CORNER_OFFSET, xAxis: -1, yAxis: -1, cursor: 'nwse-resize', label: '좌상단에서 캔버스 크기 조절', shape: 'corner' },
  { id: 'n', x: 50, y: 0, offsetX: 0, offsetY: -RESIZE_HANDLE_EDGE_OFFSET, xAxis: 0, yAxis: -1, cursor: 'ns-resize', label: '상단에서 캔버스 높이 조절', shape: 'horizontal' },
  { id: 'ne', x: 100, y: 0, offsetX: RESIZE_HANDLE_CORNER_OFFSET, offsetY: -RESIZE_HANDLE_CORNER_OFFSET, xAxis: 1, yAxis: -1, cursor: 'nesw-resize', label: '우상단에서 캔버스 크기 조절', shape: 'corner' },
  { id: 'e', x: 100, y: 50, offsetX: RESIZE_HANDLE_EDGE_OFFSET, offsetY: 0, xAxis: 1, yAxis: 0, cursor: 'ew-resize', label: '오른쪽에서 캔버스 폭 조절', shape: 'vertical' },
  { id: 'se', x: 100, y: 100, offsetX: RESIZE_HANDLE_CORNER_OFFSET, offsetY: RESIZE_HANDLE_CORNER_OFFSET, xAxis: 1, yAxis: 1, cursor: 'nwse-resize', label: '우하단에서 캔버스 크기 조절', shape: 'corner' },
  { id: 's', x: 50, y: 100, offsetX: 0, offsetY: RESIZE_HANDLE_EDGE_OFFSET, xAxis: 0, yAxis: 1, cursor: 'ns-resize', label: '하단에서 캔버스 높이 조절', shape: 'horizontal' },
  { id: 'sw', x: 0, y: 100, offsetX: -RESIZE_HANDLE_CORNER_OFFSET, offsetY: RESIZE_HANDLE_CORNER_OFFSET, xAxis: -1, yAxis: 1, cursor: 'nesw-resize', label: '좌하단에서 캔버스 크기 조절', shape: 'corner' },
  { id: 'w', x: 0, y: 50, offsetX: -RESIZE_HANDLE_EDGE_OFFSET, offsetY: 0, xAxis: -1, yAxis: 0, cursor: 'ew-resize', label: '왼쪽에서 캔버스 폭 조절', shape: 'vertical' },
] as const
